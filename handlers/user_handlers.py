...
#     user_info = rq.get_user_tg_id(tg_id=message.chat.id)
#     if not user_info:
...
#                 user_dict_player[callback.message.chat.id] == callback.data.split('_')[2]: # !!! KeyError: 6517086173, KeyError: 6669623091, KeyError: 6669623091, KeyError: 6915946557, KeyError: 5086232463
